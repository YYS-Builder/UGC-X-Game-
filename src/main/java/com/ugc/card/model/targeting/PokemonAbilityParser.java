...
public class PokemonAbilityParser implements AbilityParser {
    ...
    public PokemonAbilityParser() {
        ...
        validValues.put(ComponentCategory.TARGET, Set.of("pokemon", "energy", "trainer"));
        validValues.put(ComponentCategory.ACTION, Set.of("attack", "evolve", "attach", "search"));
